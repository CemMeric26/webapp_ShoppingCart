const items=[
    ...
    },
    {
      ...
      descritpion: "Create a web-connected light-strip API controllable from your website, using the Particle.io.",
      ratings: null
    },
    {
      ...
      descritpion: "Use an Altoids tin with Chibitronics sticker LEDs to create a light-up compact that doubles as a survival kit for the young hipster",
      ratings: null
    },
    {
      ...
      descritpion: "Visualization of sailor scouts sorted by bubblesort algorithm by their planet\u0027s distance from the sun",
      ratings: null
    },
    {
      id: "sailorhg-corsage",
      ...
      descritpion: "Light-up corsage I made with my summer intern.",
      ratings: null
    },
    {
      id: "sailorhg-kit",
      ...
      descritpion: "Pastel hardware kits complete with custom manufactured pastel alligator clips.",
      ratings: null
    },
    {
      id: "sailorhg-led",
      ...
      descritpion: "custom molded heart shaped LED with sprinkles.",
      ratings: null
    },
    {
      ...
      descritpion: "Black sweatshirt hoody with the Sick of the Internet logo.",
      ratings: null
    },
    {
      ...
      descritpion: "Still some time to enter the pin/sticker giveaway! ",
      ratings: null
    },
    {
      ...
      title: "Hipster Dev",
      descritpion: "Hipster Dev is busy coding away while styled in a camo jacket and orange beanie.",
      ratings: null
    },
    {
      ...
      descritpion: "Everyone\u2019s favorite design is finally here on a tee! The Pretty Girls Code crew-neck tee is available in a soft pink with red writing.",
      ratings: null
    },
    {
      ...
      title: "Ruby Sis",
      descritpion: "Styled in a dashiki, Ruby Sis is listening to music while coding in her favorite language, Ruby!",
      ratings: [
        3,
        5,
        5,
    ...
    },
    {
      ...
      descritpion: "Not sure if I\u0027ll be making more, get it while I have it in the store.",
      ratings: null
    },
    {
      ...
      title: "Floppy Crop",
      descritpion: "Used up the Diskette fabric today to make 2 of these crops.",
      ratings: null
    }
  ]
